...
router.post(
  "/get-all-article-by-doctor",
  article_Controller.get_all_Article_By_Email
);
router.post(
...
router.post(
  "/search-article",
  article_Controller.search_Article_By_Title_and_Content
);
router.post("/get-article-by-month", article_Controller.getArticlesByMonth);
router.get(
  "/get-article-by-speciality",
  article_Controller.getTop5ArticleBySpeciality
);
