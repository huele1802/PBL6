...
router.post(
  "/update-appointment-date/:id",
  appointment_Controller.change_Appointment_Time
);
router.post(
...
router.get(
  "/get-appointment-insr/:id",
  appointment_Controller.get_Appointment_Insurance
);
router.post(
  "/soft-delete-appointment/:id",
  appointment_Controller.soft_Delete_Appointment
);
router.post(
